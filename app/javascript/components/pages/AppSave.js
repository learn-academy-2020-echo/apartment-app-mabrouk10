...
//               console.log("id",id)
//               console.log("apts state", this.state.apartments)
...
//         <Route
//         path="/aptnew"
//         render={ (props) => <ApartmentNew createNewApt={ this.createNewApt }/> }
//         />
...
//             render={ (props) => {
//               let id = props.match.params.id
//               let apartment = this.state.apartments.find(apartment => apartments.id === parseInt(id))
//               return(
//                 <EditApartment
